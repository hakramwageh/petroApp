...
{
    public function __construct(private readonly TransferStoreInterface $transferStore) {}
    ...
    public function ingest(array $rawEvents): array
    {
        ...
        ['inserted' => $inserted, 'dbDuplicates' => $dbDuplicates] = $this->transferStore->insertBatch($uniqueEvents);
    ...
    {
        return $this->transferStore->getStationSummary($stationId)
